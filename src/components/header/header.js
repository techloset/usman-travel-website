...
const header = ({children,element}) => {
  ...
  return (
    ...
    <div  
      ...
      className=" h-[500px] md:h-[841px] w-full bg-cover  bg-no-repeat bg-center"
    >
      <nav className="h-[85px] grid grid-cols-12 grid-rows-1   justify-center items-center ">
        <img src={icon} className='ml-12 sm:hidden ' alt="" />
        <Link to='/' className="col-start-6 col-end-8  m-auto sm:m-0 sm:col-end-auto sm:col-start-2  ">
      ...
      <header className="  grid grid-cols-11 sm:grid-cols-10  grid-rows-8 grid-flow-col max-w-full h-full" >
        <p className="text-[32px] md:text-[62px] mb-10 md:mb-0 self-center  lg:text-[72px]  font-black col-start-2 col-end-10 lg:col-end-8 row-start-1 row-end-3   text-white ">
        <p className="whitespace-nowrap mr-3">  The whole world </p> awaits.
        </p>

        <div className=" rounded-2xl row-start-3  col-start-2 col-end-[-1] sm:col-end-10  flex flex-col mr-4 sm:mr-0 lg:grid grid-cols-12 grid-rows-1 lg:justify-center  lg:h-[60px] lg:items-center text-opacity-70  text-white  lg:bg-opacity-40 lg:bg-white lg:bg-backdrop-filter lg:backdrop-blur-md">
          ...
          <div className="border border-l-[1] lg:border-none">
          ...
          <div className="flex justify-center items-center py-3 md:py-5 lg:py-0  mb-5 lg:mb-0  gap-2 col-start-9   col-end-11 rounded-full bg-opacity-40 bg-white bg-backdrop-filter backdrop-blur-md    lg:bg-opacity-0 lg:bg-transparent  lg:backdrop-blur-none">
            ...
            <p className="whitespace-nowrap">1 room, 2 adults</p>
              {/* <button className="w-[100px] xl:w-[147px] h-[42px] rounded-full text-blue-600  m-auto bg-white "> */}
            {/* Search
          </button> */}       
          </div>
        ...
        <Categories></Categories>
          ...
          <div className="mt-20 lg:mt-0  row-start-7 col-start-2 col-end-12 ">
