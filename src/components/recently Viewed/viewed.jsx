...
import img1 from '../../images/recently View/1.png'
import img2 from '../../images/recently View/2.png'
import image from '../../images/recently View/3.png'
...
<h2 className="  font-bold  text-[18px] sm:text-[25px] lg:text-[32px] leading-[37px] mb-10">Recently Viewed</h2>
<div className='w-[100%] sm:w-[50%] mr-10'>
